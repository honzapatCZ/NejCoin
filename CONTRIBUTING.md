...
##Where are you from?
* We are forked from Monero made by The Monero Project which is based on CryptoNote
...
posted to #nejcoin-dev on irc.freenode.net).
...
The "Nejcoin Maintainer Team" is defined in this document as the following users:
- fluffypony
- nejcoinmooo
- hyc
...
- Users MUST NOT log feature requests, ideas, or suggestions unrelated to Nejcoin code or Nejcoin's dependency code or Nejcoin's potential/future dependency code or research which successfully implements Nejcoin.
...
- Maintainers SHOULD NOT merge their own patches except in exceptional cases, such as non-responsiveness from other Maintainers for an extended period (more than 30 days) or unless urgent as defined by the Nejcoin Maintainers Team.
...
- Maintainers MUST NOT merge pull requests in less than 168 hours (1 week) unless deemed urgent by at least 2 people from the Nejcoin Maintainer Team.
